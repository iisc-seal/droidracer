...
/*
 * The source licensed as above has been modified to add Android instrumentation 
 * code for DroidRacer. Code within the blocks delimited by "Android bug-checker" 
