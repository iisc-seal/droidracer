...
/*
 * The source licensed as above has been modified to add Android
 * instrumentation code for DroidRacer. Code within the blocks delimited by 
 * "Android bug-checker" are copyrighted and licensed as follows:
 *
            ...
            while (true) {
                ...
                synchronized (this) {
                    ...
                    synchronized (task.lock) {
                        ...
                        /*Android bug-checker*/
                        //triggering here so that if this task is periodic n re-inserted
                        //that can have a HB with current task
