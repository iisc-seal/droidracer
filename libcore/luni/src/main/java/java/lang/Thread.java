...
public class Thread implements Runnable {
    ...
    public void abcPrintCallMsg(int msgCode){
    	vmThread.abcPrintCallMsg(msgCode);
    }
    
    public void abcPrintRetMsg(int msgCode){
    	vmThread.abcPrintRetMsg(msgCode);
    }
    
    public void abcPrintAttachQueue(int queueHash){
    	vmThread.abcPrintAttachQueue(queueHash);
    } 
    
    public void abcPrintLoop(int queueHash){
    ...
    public void abcSendDbAccessInfo(String dbPath, int dbAction){
        vmThread.abcSendDbAccessInfo(dbPath, dbAction);
    } 
    
    public void abcForceAddEnableEvent(int viewHash, int eventCode){
    	vmThread.abcForceAddEnableEvent(viewHash, eventCode);
    }
	
	public void abcRemoveAllEventsOfView(int viewHash, int ignoreEvent){
		vmThread.abcRemoveAllEventsOfView(viewHash, ignoreEvent);
	}
	
	public void abcAddEnableEventForView(int viewHash, int eventType){
		vmThread.abcAddEnableEventForView(viewHash, eventType);
	}
	...
	//currently component id is its hash or -1 when not known
	public void abcEnableLifecycleEvent(String component, int compId, int status){
		vmThread.abcEnableLifecycleEvent(component, compId, status);
	}
	
	public void abcTriggerLifecycleEvent(String component, int compId, int status){
...
//	}
	...
	public void abcStopTraceGeneration(){
		vmThread.abcStopTraceGeneration();
	}
	
	public int abcGetTraceLength(){
		int length = vmThread.abcGetTraceLength();
		return length;
	}
	
	public int abcGetThreadCount(){
		int threadCount = vmThread.abcGetThreadCount();
		return threadCount;
	}
	
	public int abcGetMessageQueueCount(){
		int mqCount = vmThread.abcGetMessageQueueCount();
		return mqCount;
	}
	
	public int abcGetAsyncBlockCount(){
		int asyncBlockCount = vmThread.abcGetAsyncBlockCount();
		return asyncBlockCount;
	}
	
	public int abcGetEventTriggerCount(){
		int triggerEventCount = vmThread.abcGetEventTriggerCount();
		return triggerEventCount;
	}
	
	public int abcGetFieldCount(){
		int count = vmThread.abcGetFieldCount();
		return count;
	}
	
	public int abcGetMultiThreadedRaceCount(){
		int count = vmThread.abcGetMultiThreadedRaceCount();
		return count;
	}
	
	public int abcGetAsyncRaceCount(){
		int count = vmThread.abcGetAsyncRaceCount();
		return count;
	}
	
	public int abcGetDelayPostRaceCount(){
		int count = vmThread.abcGetDelayPostRaceCount();
		return count;
	}
	
	public int abcGetCrossPostRaceCount(){
		int count = vmThread.abcGetCrossPostRaceCount();
		return count;
	}
	
	public int abcGetCoEnabledEventUiRaces(){
		int count = vmThread.abcGetCoEnabledEventUiRaces();
		return count;
	}
	
	public int abcGetCoEnabledEventNonUiRaces(){
		int count = vmThread.abcGetCoEnabledEventNonUiRaces();
		return count;
	}
	
	public void abcPrintRacesDetectedToFile(){
		vmThread.abcPrintRacesDetectedToFile();
	}
	
	public void abcComputeMemoryUsedByRaceDetector(){
