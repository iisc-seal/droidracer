...
public class View implements Drawable.Callback, Drawable.Callback2, KeyEvent.Callback,
    ...
    */
    ...
    public void setOnClickListener(OnClickListener l) {
    	/*Android bug-checker*/
    	if(AbcGlobal.abcLogFile != null && this.isEnabled() &&
    			this.getVisibility() == View.VISIBLE){
    	    AbcGlobal.abcForceAddEnableEvent(this, 
    ...
    public void setVisibility(int visibility) {
        ...
        if(AbcGlobal.abcLogFile != null){
            AbcGlobal.abcCheckAndAddEnableEventToTrace(this, ModelCheckingDriver.EVENT_CLICK);
            AbcGlobal.abcCheckAndAddEnableEventToTrace(this, ModelCheckingDriver.EVENT_LONG_CLICK);
        }
        /*Android bug-checker*/
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        if (onFilterTouchEventForSecurity(event)) {
            ...
            if (onTouchEvent(event)) {
            	/*Android bug-checker
	        	if(AbcGlobal.abcLogFile != null){ 			
        			Thread.currentThread().abcIncrementEventCount();
	        	}
            	Android bug-checker*/
                return true;
            }
        ...
        public void run() {
            if (isPressed() && (mParent != null)
                ...
                if(Looper.mcd != null && Looper.mcd.getPackageName().equals(Looper.mcd.appUT)){
                	Looper.mcd.viewLongClickDone = true;
                }
                /*Android bug-checker*/
            }
        }
