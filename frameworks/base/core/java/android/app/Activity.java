...
public class Activity extends ContextThemeWrapper
    ...
    final void performCreate(Bundle icicle) {
    	...
    	if(Looper.mcd != null && Looper.mcd.getPackageName() != null 
    		...
    		Looper.mcd.setVisibleActivity(this);
    	}
    	/*Android bug-checker*/
    ...
    final void performResume() {
        ...
        if(Looper.mcd != null && Looper.mcd.getPackageName() != null 
			...
			Looper.mcd.activityResumed = true;
			Log.v("model_checking", "Activity " + this.getComponentName() + " is on top");
        }
        
        if(AbcGlobal.abcLogFile != null){
        	AbcGlobal.abcForceAddEnableEvent(null, 
        			ModelCheckingDriver.EVENT_BACK);
        	AbcGlobal.abcForceAddEnableEvent(null, 
        			ModelCheckingDriver.EVENT_MENU_CLICK);
        	AbcGlobal.abcForceAddEnableEvent(null, 
        			ModelCheckingDriver.EVENT_ROTATE_SCREEN);
        }
        /*Android bug-checker*/   
    }
    ...
    final void performDestroy() {
        ...
        if(Looper.mcd != null && 
      		  Looper.mcd.getPackageName() != null && Looper.mcd.getPackageName().equals(
      		Looper.mcd.appUT)){
  		Looper.mcd.setLastDestroyedActivity(this);
  		Looper.mcd.destroyTime = SystemClock.uptimeMillis();
  		Log.v("model_checking", "Activity " + this.getComponentName() + " has been destroyed");
        }
    }
