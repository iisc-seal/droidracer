/*
 * Code within the blocks delimited by "Android bug-checker" are copyrighted 
...
GOTO_TARGET(invokeVirtual, bool methodCallRange, bool jumboFormat)
    {
        ...
        /*Android bug-checker*/
        abcStoreInvokeMethodInfo(self,methodToCall,thisPtr);
        /*Android bug-checker*/
...
GOTO_TARGET(invokeSuper, bool methodCallRange, bool jumboFormat)
    {
        ...
        /*Android bug-checker*/
        abcStoreInvokeMethodInfo(self,methodToCall,(Object*) GET_REGISTER(thisReg));
        /*Android bug-checker*/
        GOTO_invokeMethod(methodCallRange, methodToCall, vsrc1, vdst);
    }
GOTO_TARGET_END
...
GOTO_TARGET(invokeStatic, bool methodCallRange, bool jumboFormat)
    ...
    /*Android bug-checker*/
    abcStoreInvokeMethodInfo(self,methodToCall,NULL);
    /*Android bug-checker*/
    GOTO_invokeMethod(methodCallRange, methodToCall, vsrc1, vdst);
GOTO_TARGET_END
